...
#   "Awards accumulate ... selling does not forfeit them"  -> folded into the never-expire row
    ...
    ('P-122', 'No contract code is deployed anywhere; the namespace is live on mainnet on all 20 chains and that part is permanent.', '**No contract code is deployed anywhere**',                        'PROCEDURE',      'OWNER',   '',                            ''),
