...
cd "$(dirname "$0")"
fail=0
for t in smartpacts-shares smartpacts-shares-init smartpacts-shares-ext smartpacts-ipo smartpacts-ipo-ext smartpacts-governance smartpacts-gas-station smartpacts-attacks smartpacts-attacks-voting smartpacts-tranches smartpacts-votekey; do
  printf '== %s ==\n' "$t"
